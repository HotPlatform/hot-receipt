...
function email(payload, done) {
  ...
  var transporter = nodemailer.createTransport('smtps://csechuan%40gmail.com:Raymond1686@smtp.gmail.com');
...
exports.postReceiptRequest = function (req, res) {
  ...
  invoice.save(input).then(function (result, err) {
    if (err) {
